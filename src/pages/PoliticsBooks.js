...
function PoliticsBooks(){

    let [booksPolitics, setBooksPolitics] = useState(null)
    let  books;

    useEffect(()=> {
        getBooksPolitics();
    },[])
    async function getBooksPolitics() {
        // console.log(title);
      ...
      const loaded = () => {
        ...
        return(<div className="App">
          ...
          return booksPolitics?loaded():loading()
     }




export default PoliticsBooks;