...
function GeographyBooks(){
    ...
    let [booksGeography, setBooksGeography] = useState(null)
    let  books;

    useEffect(()=> {
        getBooksGeography();
    },[])
    async function getBooksGeography() {
        // console.log(title);
      ...
      const loaded = () => {
        ...
        return(<div className="App">
          ...
          return booksGeography?loaded():loading()
     }
