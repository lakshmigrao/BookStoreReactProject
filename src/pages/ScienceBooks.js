...
function ScienceBooks(){
    ...
    let [booksScience, setBooksScience] = useState(null)
    let  books;

    useEffect(()=> {
        getBooksScience();
    },[])
    async function getBooksScience() {
        // console.log(title);
    
        const yourAPIKey = process.env.REACT_APP_KEY;//"AIzaSyBvJwQ-tZE4rgWnjZ9kYgnDo0ilUqz03Mc"//
        let url = `https://www.googleapis.com/books/v1/volumes?q=science+adult&maxResults=30&key=${yourAPIKey}`
      ...
      const loaded = () => {
        ...
        return(<div className="App">
          ...
          return booksScience?loaded():loading()
     }
